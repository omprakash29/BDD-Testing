...
import stepdefinition.AppHooks;

public class WebDriverHelper {
	private WebDriver driver;
	public ExtentTest test = AppHooks.test;
	...
	public void verifyText(By locator, String expectedText, Class<?> uiStoreClass) {
		...
		try {
			...
			softAssertions.assertThat(element.isDisplayed()).as(expectedText).isTrue();
			softAssertions.assertAll();
			LoggerHandler.info("verified the text: " + locatorName);
			test.log(Status.PASS,"verified the text: expectedText");
		} catch (Exception e) {
	...
	public void verifyUrl(String expectedText) {
		try {
			softAssertions = new SoftAssertions();
			String actualUrl = driver.getCurrentUrl();
			softAssertions.assertThat(actualUrl).contains(expectedText);
	...
	public void verifyTitle(String expectedText) {
		try {
			...
			softAssertions.assertThat(actualTitle).contains(expectedText);
